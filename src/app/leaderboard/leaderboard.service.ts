...
export class leaderboardService {
    private leaderboards: Map<string, Leaderboard> = new Map<string, Leaderboard>([
        ['001', new Leaderboard(1,'user','https://cdn.pixabay.com/photo/2015/02/19/03/31/man-641691_960_720.jpg',122)],
        ...
        ['010', new Leaderboard(10,'user','https://cdn.pixabay.com/photo/2015/02/19/03/31/man-641691_960_720.jpg',32)]
    ]);
